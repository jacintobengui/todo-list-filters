...
using ListaDeTarefasCT.Models;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;
using System.Diagnostics;

namespace ListaDeTarefasCT.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index(string id)
        {
            ...
            ViewBag.VencimetoValores = Filtros.VencimentoValoresFiltro;
        ...
        public IActionResult DeletarCompletos(string id)
        {
            var paraDeletar = _context.Tarefas
                .Where(t=>t.StatusId == "completo").ToList();

            _context.RemoveRange(paraDeletar);
            _context.SaveChanges();
